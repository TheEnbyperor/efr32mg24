...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn size(&mut self) -> SizeW<Array3dim0cfgSpec> {
        SizeW::new(self, 0)
    }
    #[doc = "Bits 12:13 - Element Type"]
    #[inline(always)]
    #[must_use]
    pub fn basetype(&mut self) -> BasetypeW<Array3dim0cfgSpec> {
        BasetypeW::new(self, 12)
    }
    #[doc = "Bit 14 - Complex Data Type"]
    #[inline(always)]
    #[must_use]
    pub fn complex(&mut self) -> ComplexW<Array3dim0cfgSpec> {
        ComplexW::new(self, 14)
    }
    #[doc = "Bits 16:27 - Dimension Stride Step"]
    #[inline(always)]
    #[must_use]
    pub fn stride(&mut self) -> StrideW<Array3dim0cfgSpec> {
        StrideW::new(self, 16)
    }
}
