#[doc = "Register `LOOP2RST` reader"]
pub type R = crate::R<Loop2rstSpec>;
#[doc = "Register `LOOP2RST` writer"]
pub type W = crate::W<Loop2rstSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn array0resetdim0(&mut self) -> Array0resetdim0W<Loop2rstSpec> {
        Array0resetdim0W::new(self, 12)
    }
    #[doc = "Bit 13 - Reset Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn array0resetdim1(&mut self) -> Array0resetdim1W<Loop2rstSpec> {
        Array0resetdim1W::new(self, 13)
    }
    #[doc = "Bit 14 - Reset Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn array0resetdim2(&mut self) -> Array0resetdim2W<Loop2rstSpec> {
        Array0resetdim2W::new(self, 14)
    }
    #[doc = "Bit 16 - Reset Dimension 0"]
    #[inline(always)]
    #[must_use]
    pub fn array1resetdim0(&mut self) -> Array1resetdim0W<Loop2rstSpec> {
        Array1resetdim0W::new(self, 16)
    }
    #[doc = "Bit 17 - Reset Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn array1resetdim1(&mut self) -> Array1resetdim1W<Loop2rstSpec> {
        Array1resetdim1W::new(self, 17)
    }
    #[doc = "Bit 18 - Reset Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn array1resetdim2(&mut self) -> Array1resetdim2W<Loop2rstSpec> {
        Array1resetdim2W::new(self, 18)
    }
    #[doc = "Bit 20 - Reset Dimension 0"]
    #[inline(always)]
    #[must_use]
    pub fn array2resetdim0(&mut self) -> Array2resetdim0W<Loop2rstSpec> {
        Array2resetdim0W::new(self, 20)
    }
    #[doc = "Bit 21 - Reset Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn array2resetdim1(&mut self) -> Array2resetdim1W<Loop2rstSpec> {
        Array2resetdim1W::new(self, 21)
    }
    #[doc = "Bit 22 - Reset Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn array2resetdim2(&mut self) -> Array2resetdim2W<Loop2rstSpec> {
        Array2resetdim2W::new(self, 22)
    }
    #[doc = "Bit 24 - Reset Dimension 0"]
    #[inline(always)]
    #[must_use]
    pub fn array3resetdim0(&mut self) -> Array3resetdim0W<Loop2rstSpec> {
        Array3resetdim0W::new(self, 24)
    }
    #[doc = "Bit 25 - Reset Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn array3resetdim1(&mut self) -> Array3resetdim1W<Loop2rstSpec> {
        Array3resetdim1W::new(self, 25)
    }
    #[doc = "Bit 26 - Reset Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn array3resetdim2(&mut self) -> Array3resetdim2W<Loop2rstSpec> {
        Array3resetdim2W::new(self, 26)
    }
    #[doc = "Bit 28 - Reset Dimension 0"]
    #[inline(always)]
    #[must_use]
    pub fn array4resetdim0(&mut self) -> Array4resetdim0W<Loop2rstSpec> {
        Array4resetdim0W::new(self, 28)
    }
    #[doc = "Bit 29 - Reset Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn array4resetdim1(&mut self) -> Array4resetdim1W<Loop2rstSpec> {
        Array4resetdim1W::new(self, 29)
    }
    #[doc = "Bit 30 - Reset Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn array4resetdim2(&mut self) -> Array4resetdim2W<Loop2rstSpec> {
        Array4resetdim2W::new(self, 30)
    }
}
#[doc = "Loop N Reset Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`loop2rst::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`loop2rst::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Loop2rstSpec;
impl crate::RegisterSpec for Loop2rstSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`loop2rst::R`](R) reader structure"]
impl crate::Readable for Loop2rstSpec {}
#[doc = "`write(|w| ..)` method takes [`loop2rst::W`](W) writer structure"]
impl crate::Writable for Loop2rstSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LOOP2RST to value 0"]
impl crate::Resettable for Loop2rstSpec {
