...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dim0index(&mut self) -> Dim0indexW<Array3indexstateSpec> {
        Dim0indexW::new(self, 0)
    }
    #[doc = "Bits 10:19 - Current Index"]
    #[inline(always)]
    #[must_use]
    pub fn dim1index(&mut self) -> Dim1indexW<Array3indexstateSpec> {
        Dim1indexW::new(self, 10)
    }
    #[doc = "Bits 20:29 - Current Index"]
    #[inline(always)]
    #[must_use]
    pub fn dim2index(&mut self) -> Dim2indexW<Array3indexstateSpec> {
