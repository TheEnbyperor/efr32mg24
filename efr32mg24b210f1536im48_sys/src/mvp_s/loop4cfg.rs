#[doc = "Register `LOOP4CFG` reader"]
pub type R = crate::R<Loop4cfgSpec>;
#[doc = "Register `LOOP4CFG` writer"]
pub type W = crate::W<Loop4cfgSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn numiters(&mut self) -> NumitersW<Loop4cfgSpec> {
        NumitersW::new(self, 0)
    }
    #[doc = "Bit 12 - Increment Dimension 0"]
    #[inline(always)]
    #[must_use]
    pub fn array0incrdim0(&mut self) -> Array0incrdim0W<Loop4cfgSpec> {
        Array0incrdim0W::new(self, 12)
    }
    #[doc = "Bit 13 - Increment Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn array0incrdim1(&mut self) -> Array0incrdim1W<Loop4cfgSpec> {
        Array0incrdim1W::new(self, 13)
    }
    #[doc = "Bit 14 - Increment Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn array0incrdim2(&mut self) -> Array0incrdim2W<Loop4cfgSpec> {
        Array0incrdim2W::new(self, 14)
    }
    #[doc = "Bit 16 - Increment Dimension 0"]
    #[inline(always)]
    #[must_use]
    pub fn array1incrdim0(&mut self) -> Array1incrdim0W<Loop4cfgSpec> {
        Array1incrdim0W::new(self, 16)
    }
    #[doc = "Bit 17 - Increment Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn array1incrdim1(&mut self) -> Array1incrdim1W<Loop4cfgSpec> {
        Array1incrdim1W::new(self, 17)
    }
    #[doc = "Bit 18 - Increment Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn array1incrdim2(&mut self) -> Array1incrdim2W<Loop4cfgSpec> {
        Array1incrdim2W::new(self, 18)
    }
    #[doc = "Bit 20 - Increment Dimension 0"]
    #[inline(always)]
    #[must_use]
    pub fn array2incrdim0(&mut self) -> Array2incrdim0W<Loop4cfgSpec> {
        Array2incrdim0W::new(self, 20)
    }
    #[doc = "Bit 21 - Increment Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn array2incrdim1(&mut self) -> Array2incrdim1W<Loop4cfgSpec> {
        Array2incrdim1W::new(self, 21)
    }
    #[doc = "Bit 22 - Increment Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn array2incrdim2(&mut self) -> Array2incrdim2W<Loop4cfgSpec> {
        Array2incrdim2W::new(self, 22)
    }
    #[doc = "Bit 24 - Increment Dimension 0"]
    #[inline(always)]
    #[must_use]
    pub fn array3incrdim0(&mut self) -> Array3incrdim0W<Loop4cfgSpec> {
        Array3incrdim0W::new(self, 24)
    }
    #[doc = "Bit 25 - Increment Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn array3incrdim1(&mut self) -> Array3incrdim1W<Loop4cfgSpec> {
        Array3incrdim1W::new(self, 25)
    }
    #[doc = "Bit 26 - Increment Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn array3incrdim2(&mut self) -> Array3incrdim2W<Loop4cfgSpec> {
        Array3incrdim2W::new(self, 26)
    }
    #[doc = "Bit 28 - Increment Dimension 0"]
    #[inline(always)]
    #[must_use]
    pub fn array4incrdim0(&mut self) -> Array4incrdim0W<Loop4cfgSpec> {
        Array4incrdim0W::new(self, 28)
    }
    #[doc = "Bit 29 - Increment Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn array4incrdim1(&mut self) -> Array4incrdim1W<Loop4cfgSpec> {
        Array4incrdim1W::new(self, 29)
    }
    #[doc = "Bit 30 - Increment Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn array4incrdim2(&mut self) -> Array4incrdim2W<Loop4cfgSpec> {
        Array4incrdim2W::new(self, 30)
    }
}
#[doc = "Loop N Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`loop4cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`loop4cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Loop4cfgSpec;
impl crate::RegisterSpec for Loop4cfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`loop4cfg::R`](R) reader structure"]
impl crate::Readable for Loop4cfgSpec {}
#[doc = "`write(|w| ..)` method takes [`loop4cfg::W`](W) writer structure"]
impl crate::Writable for Loop4cfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LOOP4CFG to value 0"]
impl crate::Resettable for Loop4cfgSpec {
