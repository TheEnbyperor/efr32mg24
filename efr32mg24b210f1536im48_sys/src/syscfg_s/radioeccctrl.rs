...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn seqrameccen(&mut self) -> SeqrameccenW<RadioeccctrlSpec> {
        SeqrameccenW::new(self, 0)
    }
    #[doc = "Bit 1 - SEQRAM ECC Error Writeback Enable"]
    #[inline(always)]
    #[must_use]
    pub fn seqrameccewen(&mut self) -> SeqrameccewenW<RadioeccctrlSpec> {
        SeqrameccewenW::new(self, 1)
    }
    #[doc = "Bit 8 - FRCRAM ECC Enable"]
    #[inline(always)]
    #[must_use]
    pub fn frcrameccen(&mut self) -> FrcrameccenW<RadioeccctrlSpec> {
        FrcrameccenW::new(self, 8)
    }
    #[doc = "Bit 9 - FRCRAM ECC Error Writeback Enable"]
    #[inline(always)]
    #[must_use]
    pub fn frcrameccewen(&mut self) -> FrcrameccewenW<RadioeccctrlSpec> {
