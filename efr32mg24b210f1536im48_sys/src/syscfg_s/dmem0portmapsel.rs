...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mvpahbdata0portsel(&mut self) -> Mvpahbdata0portselW<Dmem0portmapselSpec> {
        Mvpahbdata0portselW::new(self, 10)
    }
    #[doc = "Bits 12:13 - MVPAHBDATA1 portmap selection"]
    #[inline(always)]
    #[must_use]
    pub fn mvpahbdata1portsel(&mut self) -> Mvpahbdata1portselW<Dmem0portmapselSpec> {
        Mvpahbdata1portselW::new(self, 12)
    }
    #[doc = "Bits 14:15 - MVPAHBDATA2 portmap selection"]
    #[inline(always)]
    #[must_use]
    pub fn mvpahbdata2portsel(&mut self) -> Mvpahbdata2portselW<Dmem0portmapselSpec> {
