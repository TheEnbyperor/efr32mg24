...
pub enum Portneg {
    ...
    Padana1 = 4,
    #[doc = "5: Direct connection to AIN3 input pin"]
    Padana3 = 5,
...
impl PortnegR {
    ...
    pub const fn variant(&self) -> Option<Portneg> {
        match self.bits {
            0 => Some(Portneg::Gnd),
            2 => Some(Portneg::Dac1),
            4 => Some(Portneg::Padana1),
            5 => Some(Portneg::Padana3),
    ...
    pub fn is_padana1(&self) -> bool {
        *self == Portneg::Padana1
    }
    #[doc = "Direct connection to AIN3 input pin"]
    #[inline(always)]
    pub fn is_padana3(&self) -> bool {
        *self == Portneg::Padana3
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Direct connection to AIN1 input pin"]
    #[inline(always)]
    pub fn padana1(self) -> &'a mut crate::W<REG> {
        self.variant(Portneg::Padana1)
    }
    #[doc = "Direct connection to AIN3 input pin"]
    #[inline(always)]
    pub fn padana3(self) -> &'a mut crate::W<REG> {
        self.variant(Portneg::Padana3)
    }
    #[doc = "Port A - Select pin number using PINNEG"]
    #[inline(always)]
...
pub enum Portpos {
    ...
    Padana0 = 4,
    #[doc = "5: Direct connection to AIN2 input pin"]
    Padana2 = 5,
...
impl PortposR {
    ...
    pub const fn variant(&self) -> Option<Portpos> {
        match self.bits {
            ...
            2 => Some(Portpos::Dac0),
            4 => Some(Portpos::Padana0),
            5 => Some(Portpos::Padana2),
    ...
    pub fn is_padana0(&self) -> bool {
        *self == Portpos::Padana0
    }
    #[doc = "Direct connection to AIN2 input pin"]
    #[inline(always)]
    pub fn is_padana2(&self) -> bool {
        *self == Portpos::Padana2
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Direct connection to AIN0 input pin"]
    #[inline(always)]
    pub fn padana0(self) -> &'a mut crate::W<REG> {
        self.variant(Portpos::Padana0)
    }
    #[doc = "Direct connection to AIN2 input pin"]
    #[inline(always)]
    pub fn padana2(self) -> &'a mut crate::W<REG> {
        self.variant(Portpos::Padana2)
    }
    #[doc = "Port A - Select pin number using PINPOS"]
    #[inline(always)]
    pub fn porta(self) -> &'a mut crate::W<REG> {
