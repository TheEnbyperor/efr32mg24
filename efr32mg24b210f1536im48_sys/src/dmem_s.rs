...
pub struct RegisterBlock {
    ...
    eccerraddr2: Eccerraddr2,
    eccerraddr3: Eccerraddr3,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn eccerraddr2(&self) -> &Eccerraddr2 {
        &self.eccerraddr2
    }
    #[doc = "0x18 - No Description"]
    #[inline(always)]
    pub const fn eccerraddr3(&self) -> &Eccerraddr3 {
        &self.eccerraddr3
    }
...
#[doc = "No Description"]
pub mod eccerraddr1;
#[doc = "ECCERRADDR2 (r) register accessor: No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`eccerraddr2::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@eccerraddr2`]
module"]
#[doc(alias = "ECCERRADDR2")]
pub type Eccerraddr2 = crate::Reg<eccerraddr2::Eccerraddr2Spec>;
#[doc = "No Description"]
pub mod eccerraddr2;
#[doc = "ECCERRADDR3 (r) register accessor: No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`eccerraddr3::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@eccerraddr3`]
module"]
#[doc(alias = "ECCERRADDR3")]
pub type Eccerraddr3 = crate::Reg<eccerraddr3::Eccerraddr3Spec>;
#[doc = "No Description"]
pub mod eccerraddr3;
