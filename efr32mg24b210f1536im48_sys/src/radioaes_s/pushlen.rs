...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn length(&mut self) -> LengthW<PushlenSpec> {
        LengthW::new(self, 0)
    }
    #[doc = "Bit 28 - Constant address"]
    #[inline(always)]
    #[must_use]
    pub fn constaddr(&mut self) -> ConstaddrW<PushlenSpec> {
        ConstaddrW::new(self, 28)
    }
    #[doc = "Bit 29 - Realign length"]
    #[inline(always)]
    #[must_use]
    pub fn realign(&mut self) -> RealignW<PushlenSpec> {
        RealignW::new(self, 29)
    }
    #[doc = "Bit 30 - Discard data"]
    #[inline(always)]
    #[must_use]
    pub fn discard(&mut self) -> DiscardW<PushlenSpec> {
