...
pub type R = crate::R<Timer0Cdti2routeSpec>;
#[doc = "Register `TIMER0_CDTI2ROUTE` writer"]
pub type W = crate::W<Timer0Cdti2routeSpec>;
...
pub struct Timer0Cdti2routeSpec;
impl crate::RegisterSpec for Timer0Cdti2routeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timer0_cdti2route::R`](R) reader structure"]
impl crate::Readable for Timer0Cdti2routeSpec {}
