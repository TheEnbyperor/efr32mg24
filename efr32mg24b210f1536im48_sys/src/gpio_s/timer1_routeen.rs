...
pub type R = crate::R<Timer1RouteenSpec>;
#[doc = "Register `TIMER1_ROUTEEN` writer"]
pub type W = crate::W<Timer1RouteenSpec>;
...
pub struct Timer1RouteenSpec;
impl crate::RegisterSpec for Timer1RouteenSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timer1_routeen::R`](R) reader structure"]
impl crate::Readable for Timer1RouteenSpec {}
