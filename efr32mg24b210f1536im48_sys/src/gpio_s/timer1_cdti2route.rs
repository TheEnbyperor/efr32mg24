...
pub type R = crate::R<Timer1Cdti2routeSpec>;
#[doc = "Register `TIMER1_CDTI2ROUTE` writer"]
pub type W = crate::W<Timer1Cdti2routeSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn port(&mut self) -> PortW<Timer1Cdti2routeSpec> {
        PortW::new(self, 0)
    }
    #[doc = "Bits 16:19 - CDTI2 pin select register"]
    #[inline(always)]
    #[must_use]
    pub fn pin(&mut self) -> PinW<Timer1Cdti2routeSpec> {
        PinW::new(self, 16)
    }
}
...
pub struct Timer1Cdti2routeSpec;
impl crate::RegisterSpec for Timer1Cdti2routeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timer1_cdti2route::R`](R) reader structure"]
impl crate::Readable for Timer1Cdti2routeSpec {}
#[doc = "`write(|w| ..)` method takes [`timer1_cdti2route::W`](W) writer structure"]
impl crate::Writable for Timer1Cdti2routeSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TIMER1_CDTI2ROUTE to value 0"]
impl crate::Resettable for Timer1Cdti2routeSpec {
