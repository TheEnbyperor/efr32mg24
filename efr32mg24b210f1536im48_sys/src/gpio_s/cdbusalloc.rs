...
pub enum Cdeven0 {
    ...
    Vdac0ch0 = 4,
    #[doc = "5: The bus is allocated to VDAC1 CH0"]
    Vdac1ch0 = 5,
}
...
impl Cdeven0R {
    ...
    #[doc = "The bus is allocated to VDAC1 CH0"]
    #[inline(always)]
    pub fn is_vdac1ch0(&self) -> bool {
        *self == Cdeven0::Vdac1ch0
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "The bus is allocated to VDAC1 CH0"]
    #[inline(always)]
    pub fn vdac1ch0(self) -> &'a mut crate::W<REG> {
        self.variant(Cdeven0::Vdac1ch0)
    }
}
#[doc = "CD Bus Even 1\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub enum Cdeven1 {
    ...
    Vdac0ch1 = 4,
    #[doc = "5: The bus is allocated to VDAC1 CH1"]
    Vdac1ch1 = 5,
}
...
impl Cdeven1R {
    ...
    #[doc = "The bus is allocated to VDAC1 CH1"]
    #[inline(always)]
    pub fn is_vdac1ch1(&self) -> bool {
        *self == Cdeven1::Vdac1ch1
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "The bus is allocated to VDAC1 CH1"]
    #[inline(always)]
    pub fn vdac1ch1(self) -> &'a mut crate::W<REG> {
        self.variant(Cdeven1::Vdac1ch1)
    }
}
#[doc = "CD Bus Odd 0\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
