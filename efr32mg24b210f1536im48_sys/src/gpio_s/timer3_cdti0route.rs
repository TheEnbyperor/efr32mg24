...
pub type R = crate::R<Timer3Cdti0routeSpec>;
#[doc = "Register `TIMER3_CDTI0ROUTE` writer"]
pub type W = crate::W<Timer3Cdti0routeSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn port(&mut self) -> PortW<Timer3Cdti0routeSpec> {
        PortW::new(self, 0)
    }
    #[doc = "Bits 16:19 - CDTI0 pin select register"]
    #[inline(always)]
    #[must_use]
    pub fn pin(&mut self) -> PinW<Timer3Cdti0routeSpec> {
        PinW::new(self, 16)
    }
}
...
pub struct Timer3Cdti0routeSpec;
impl crate::RegisterSpec for Timer3Cdti0routeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timer3_cdti0route::R`](R) reader structure"]
impl crate::Readable for Timer3Cdti0routeSpec {}
#[doc = "`write(|w| ..)` method takes [`timer3_cdti0route::W`](W) writer structure"]
impl crate::Writable for Timer3Cdti0routeSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TIMER3_CDTI0ROUTE to value 0"]
impl crate::Resettable for Timer3Cdti0routeSpec {
