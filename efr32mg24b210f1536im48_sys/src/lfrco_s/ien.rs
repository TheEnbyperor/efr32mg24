...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcdone(&mut self) -> TcdoneW<IenSpec> {
        TcdoneW::new(self, 8)
    }
    #[doc = "Bit 9 - Calibration Done Enable"]
    #[inline(always)]
    #[must_use]
    pub fn caldone(&mut self) -> CaldoneW<IenSpec> {
        CaldoneW::new(self, 9)
    }
    #[doc = "Bit 10 - Temperature Change Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tempchange(&mut self) -> TempchangeW<IenSpec> {
        TempchangeW::new(self, 10)
    }
    #[doc = "Bit 16 - Scheduling Error Enable"]
    #[inline(always)]
    #[must_use]
    pub fn schederr(&mut self) -> SchederrW<IenSpec> {
        SchederrW::new(self, 16)
    }
    #[doc = "Bit 17 - Temperature Check Out Of Range Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tcoor(&mut self) -> TcoorW<IenSpec> {
        TcoorW::new(self, 17)
    }
    #[doc = "Bit 18 - Calibration Out Of Range Enable"]
    #[inline(always)]
    #[must_use]
    pub fn caloor(&mut self) -> CaloorW<IenSpec> {
        CaloorW::new(self, 18)
    }
}
