...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcdone(&mut self) -> TcdoneW<IfSpec> {
        TcdoneW::new(self, 8)
    }
    #[doc = "Bit 9 - Calibration Done Flag"]
    #[inline(always)]
    #[must_use]
    pub fn caldone(&mut self) -> CaldoneW<IfSpec> {
        CaldoneW::new(self, 9)
    }
    #[doc = "Bit 10 - Temperature Change Flag"]
    #[inline(always)]
    #[must_use]
    pub fn tempchange(&mut self) -> TempchangeW<IfSpec> {
        TempchangeW::new(self, 10)
    }
    #[doc = "Bit 16 - Scheduling Error Flag"]
    #[inline(always)]
    #[must_use]
    pub fn schederr(&mut self) -> SchederrW<IfSpec> {
        SchederrW::new(self, 16)
    }
    #[doc = "Bit 17 - Temperature Check Out Of Range Flag"]
    #[inline(always)]
    #[must_use]
    pub fn tcoor(&mut self) -> TcoorW<IfSpec> {
        TcoorW::new(self, 17)
    }
    #[doc = "Bit 18 - Calibration Out Of Range Flag"]
    #[inline(always)]
    #[must_use]
    pub fn caloor(&mut self) -> CaloorW<IfSpec> {
        CaloorW::new(self, 18)
    }
}
