...
pub type R = crate::R<Wdog1clkctrlSpec>;
#[doc = "Register `WDOG1CLKCTRL` writer"]
pub type W = crate::W<Wdog1clkctrlSpec>;
#[doc = "Clock Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clksel(&mut self) -> ClkselW<Wdog1clkctrlSpec> {
        ClkselW::new(self, 0)
    }
}
...
pub struct Wdog1clkctrlSpec;
impl crate::RegisterSpec for Wdog1clkctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wdog1clkctrl::R`](R) reader structure"]
impl crate::Readable for Wdog1clkctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`wdog1clkctrl::W`](W) writer structure"]
impl crate::Writable for Wdog1clkctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets WDOG1CLKCTRL to value 0x01"]
impl crate::Resettable for Wdog1clkctrlSpec {
