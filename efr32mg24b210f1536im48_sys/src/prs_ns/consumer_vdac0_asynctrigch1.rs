...
pub type R = crate::R<ConsumerVdac0Asynctrigch1Spec>;
#[doc = "Register `CONSUMER_VDAC0_ASYNCTRIGCH1` writer"]
pub type W = crate::W<ConsumerVdac0Asynctrigch1Spec>;
...
pub struct ConsumerVdac0Asynctrigch1Spec;
impl crate::RegisterSpec for ConsumerVdac0Asynctrigch1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`consumer_vdac0_asynctrigch1::R`](R) reader structure"]
impl crate::Readable for ConsumerVdac0Asynctrigch1Spec {}
