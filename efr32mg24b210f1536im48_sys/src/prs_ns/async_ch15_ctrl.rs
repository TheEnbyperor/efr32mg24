#[doc = "Register `ASYNC_CH15_CTRL` reader"]
pub type R = crate::R<AsyncCh15CtrlSpec>;
#[doc = "Register `ASYNC_CH15_CTRL` writer"]
pub type W = crate::W<AsyncCh15CtrlSpec>;
#[doc = "Signal Select\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sigsel(&mut self) -> SigselW<AsyncCh15CtrlSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn sourcesel(&mut self) -> SourceselW<AsyncCh15CtrlSpec> {
        SourceselW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Function Select"]
    #[inline(always)]
    #[must_use]
    pub fn fnsel(&mut self) -> FnselW<AsyncCh15CtrlSpec> {
        FnselW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Aux Select"]
    #[inline(always)]
    #[must_use]
    pub fn auxsel(&mut self) -> AuxselW<AsyncCh15CtrlSpec> {
        AuxselW::new(self, 24)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`async_ch15_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`async_ch15_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AsyncCh15CtrlSpec;
impl crate::RegisterSpec for AsyncCh15CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`async_ch15_ctrl::R`](R) reader structure"]
impl crate::Readable for AsyncCh15CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`async_ch15_ctrl::W`](W) writer structure"]
impl crate::Writable for AsyncCh15CtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ASYNC_CH15_CTRL to value 0x000c_0000"]
impl crate::Resettable for AsyncCh15CtrlSpec {
