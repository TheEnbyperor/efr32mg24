...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sigsel(&mut self) -> SigselW<AsyncCh0CtrlSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn sourcesel(&mut self) -> SourceselW<AsyncCh0CtrlSpec> {
        SourceselW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Function Select"]
    #[inline(always)]
    #[must_use]
    pub fn fnsel(&mut self) -> FnselW<AsyncCh0CtrlSpec> {
        FnselW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Aux Select"]
    #[inline(always)]
    #[must_use]
    pub fn auxsel(&mut self) -> AuxselW<AsyncCh0CtrlSpec> {
        AuxselW::new(self, 24)
    }
}
