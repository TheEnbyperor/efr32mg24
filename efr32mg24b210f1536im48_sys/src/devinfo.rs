...
impl RegisterBlock {
    ...
    #[doc = "0x264 - FENOTCH Calibration"]
    #[inline(always)]
    pub const fn fenotchcal(&self) -> &Fenotchcal {
        &self.fenotchcal
    }
}
...
pub mod rtherm;
#[doc = "FENOTCHCAL (r) register accessor: FENOTCH Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`fenotchcal::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fenotchcal`]
module"]
#[doc(alias = "FENOTCHCAL")]
pub type Fenotchcal = crate::Reg<fenotchcal::FenotchcalSpec>;
