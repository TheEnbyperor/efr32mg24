...
pub type R = crate::R<Hfrcodpllcal8Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal8Spec;
impl crate::RegisterSpec for Hfrcodpllcal8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal8::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal8Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL8 to value 0"]
impl crate::Resettable for Hfrcodpllcal8Spec {
