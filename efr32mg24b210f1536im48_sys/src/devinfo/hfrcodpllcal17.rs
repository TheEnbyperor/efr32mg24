...
pub type R = crate::R<Hfrcodpllcal17Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal17::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal17Spec;
impl crate::RegisterSpec for Hfrcodpllcal17Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal17::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal17Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL17 to value 0"]
impl crate::Resettable for Hfrcodpllcal17Spec {
