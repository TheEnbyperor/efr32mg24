...
pub type R = crate::R<Hfrcodpllcal3Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal3Spec;
impl crate::RegisterSpec for Hfrcodpllcal3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal3::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal3Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL3 to value 0"]
impl crate::Resettable for Hfrcodpllcal3Spec {
