...
pub type R = crate::R<Hfrcodpllcal11Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal11::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal11Spec;
impl crate::RegisterSpec for Hfrcodpllcal11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal11::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal11Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL11 to value 0"]
impl crate::Resettable for Hfrcodpllcal11Spec {
