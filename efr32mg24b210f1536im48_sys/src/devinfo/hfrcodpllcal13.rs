...
pub type R = crate::R<Hfrcodpllcal13Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal13::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal13Spec;
impl crate::RegisterSpec for Hfrcodpllcal13Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal13::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal13Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL13 to value 0"]
impl crate::Resettable for Hfrcodpllcal13Spec {
