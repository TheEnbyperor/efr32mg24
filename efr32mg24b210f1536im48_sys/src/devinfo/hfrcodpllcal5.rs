...
pub type R = crate::R<Hfrcodpllcal5Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal5::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal5Spec;
impl crate::RegisterSpec for Hfrcodpllcal5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal5::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal5Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL5 to value 0"]
impl crate::Resettable for Hfrcodpllcal5Spec {
