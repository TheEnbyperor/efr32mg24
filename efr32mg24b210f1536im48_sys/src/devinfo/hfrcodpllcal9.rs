...
pub type R = crate::R<Hfrcodpllcal9Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal9::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal9Spec;
impl crate::RegisterSpec for Hfrcodpllcal9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal9::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal9Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL9 to value 0"]
impl crate::Resettable for Hfrcodpllcal9Spec {
