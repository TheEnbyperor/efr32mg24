...
pub type R = crate::R<Hfrcodpllcal4Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal4Spec;
impl crate::RegisterSpec for Hfrcodpllcal4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal4::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal4Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL4 to value 0"]
impl crate::Resettable for Hfrcodpllcal4Spec {
