...
pub type R = crate::R<Hfrcoem23cal2Spec>;
...
#[doc = "HFRCOEM23 Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcoem23cal2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcoem23cal2Spec;
impl crate::RegisterSpec for Hfrcoem23cal2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcoem23cal2::R`](R) reader structure"]
impl crate::Readable for Hfrcoem23cal2Spec {}
#[doc = "`reset()` method sets HFRCOEM23CAL2 to value 0"]
impl crate::Resettable for Hfrcoem23cal2Spec {
