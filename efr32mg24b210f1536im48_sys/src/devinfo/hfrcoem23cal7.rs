...
pub type R = crate::R<Hfrcoem23cal7Spec>;
...
#[doc = "HFRCOEM23 Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcoem23cal7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcoem23cal7Spec;
impl crate::RegisterSpec for Hfrcoem23cal7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcoem23cal7::R`](R) reader structure"]
impl crate::Readable for Hfrcoem23cal7Spec {}
#[doc = "`reset()` method sets HFRCOEM23CAL7 to value 0"]
impl crate::Resettable for Hfrcoem23cal7Spec {
