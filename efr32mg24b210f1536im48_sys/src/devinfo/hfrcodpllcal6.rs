...
pub type R = crate::R<Hfrcodpllcal6Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal6::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal6Spec;
impl crate::RegisterSpec for Hfrcodpllcal6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal6::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal6Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL6 to value 0"]
impl crate::Resettable for Hfrcodpllcal6Spec {
