...
pub type R = crate::R<Hfrcodpllcal7Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal7Spec;
impl crate::RegisterSpec for Hfrcodpllcal7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal7::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal7Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL7 to value 0"]
impl crate::Resettable for Hfrcodpllcal7Spec {
