...
pub type R = crate::R<Hfrcodpllcal0Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal0Spec;
impl crate::RegisterSpec for Hfrcodpllcal0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal0::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal0Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL0 to value 0"]
impl crate::Resettable for Hfrcodpllcal0Spec {
