...
pub type R = crate::R<Hfrcodpllcal2Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal2Spec;
impl crate::RegisterSpec for Hfrcodpllcal2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal2::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal2Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL2 to value 0"]
impl crate::Resettable for Hfrcodpllcal2Spec {
