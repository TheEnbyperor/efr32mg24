...
pub type R = crate::R<Hfrcodpllcal10Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal10::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal10Spec;
impl crate::RegisterSpec for Hfrcodpllcal10Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal10::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal10Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL10 to value 0"]
impl crate::Resettable for Hfrcodpllcal10Spec {
