...
pub type R = crate::R<Hfrcodpllcal12Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal12::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal12Spec;
impl crate::RegisterSpec for Hfrcodpllcal12Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal12::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal12Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL12 to value 0"]
impl crate::Resettable for Hfrcodpllcal12Spec {
