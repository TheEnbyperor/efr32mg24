...
pub type R = crate::R<Hfrcodpllcal1Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal1Spec;
impl crate::RegisterSpec for Hfrcodpllcal1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal1::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal1Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL1 to value 0"]
impl crate::Resettable for Hfrcodpllcal1Spec {
