...
pub type R = crate::R<Hfrcodpllcal16Spec>;
...
#[doc = "HFRCODPLL Calibration\n\nYou can [`read`](crate::Reg::read) this register and get [`hfrcodpllcal16::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hfrcodpllcal16Spec;
impl crate::RegisterSpec for Hfrcodpllcal16Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfrcodpllcal16::R`](R) reader structure"]
impl crate::Readable for Hfrcodpllcal16Spec {}
#[doc = "`reset()` method sets HFRCODPLLCAL16 to value 0"]
impl crate::Resettable for Hfrcodpllcal16Spec {
