...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn radioaes(&mut self) -> RadioaesW<Ppusatd1Spec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vdac1(&mut self) -> Vdac1W<Ppusatd1Spec> {
        Vdac1W::new(self, 11)
    }
    #[doc = "Bit 12 - PCNT Secure Access"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn mvp(&mut self) -> MvpW<Ppusatd1Spec> {
        MvpW::new(self, 20)
    }
    #[doc = "Bit 21 - AHBRADIO Secure Access"]
    #[inline(always)]
    #[must_use]
    pub fn ahbradio(&mut self) -> AhbradioW<Ppusatd1Spec> {
