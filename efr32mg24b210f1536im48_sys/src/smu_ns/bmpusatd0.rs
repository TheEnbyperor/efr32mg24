...
#[doc = "Field `MVPAHBDATA0` reader - MVPAHBDATA0 secure mode"]
pub type Mvpahbdata0R = crate::BitReader;
#[doc = "Field `MVPAHBDATA0` writer - MVPAHBDATA0 secure mode"]
pub type Mvpahbdata0W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MVPAHBDATA1` reader - MVPAHBDATA1 secure mode"]
pub type Mvpahbdata1R = crate::BitReader;
#[doc = "Field `MVPAHBDATA1` writer - MVPAHBDATA1 secure mode"]
pub type Mvpahbdata1W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MVPAHBDATA2` reader - MVPAHBDATA2 secure mode"]
pub type Mvpahbdata2R = crate::BitReader;
#[doc = "Field `MVPAHBDATA2` writer - MVPAHBDATA2 secure mode"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn radioaes(&mut self) -> RadioaesW<Bmpusatd0Spec> {
        RadioaesW::new(self, 0)
    }
    #[doc = "Bit 1 - RADIO subsystem manager secure mode"]
    #[inline(always)]
    #[must_use]
    pub fn radiosubsystem(&mut self) -> RadiosubsystemW<Bmpusatd0Spec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mvpahbdata0(&mut self) -> Mvpahbdata0W<Bmpusatd0Spec> {
        Mvpahbdata0W::new(self, 3)
    }
    #[doc = "Bit 4 - MVPAHBDATA1 secure mode"]
    #[inline(always)]
    #[must_use]
    pub fn mvpahbdata1(&mut self) -> Mvpahbdata1W<Bmpusatd0Spec> {
        Mvpahbdata1W::new(self, 4)
    }
    #[doc = "Bit 5 - MVPAHBDATA2 secure mode"]
    #[inline(always)]
    #[must_use]
    pub fn mvpahbdata2(&mut self) -> Mvpahbdata2W<Bmpusatd0Spec> {
        Mvpahbdata2W::new(self, 5)
    }
    #[doc = "Bit 6 - RFECA0 secure mode"]
    #[inline(always)]
    #[must_use]
    pub fn rfeca0(&mut self) -> Rfeca0W<Bmpusatd0Spec> {
        Rfeca0W::new(self, 6)
    }
    #[doc = "Bit 7 - RFECA1 secure mode"]
    #[inline(always)]
    #[must_use]
    pub fn rfeca1(&mut self) -> Rfeca1W<Bmpusatd0Spec> {
        Rfeca1W::new(self, 7)
    }
    #[doc = "Bit 8 - SEEXTDMA secure mode"]
    #[inline(always)]
