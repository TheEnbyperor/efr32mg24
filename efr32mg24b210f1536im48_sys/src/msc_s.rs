...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn pagelock2(&self) -> &Pagelock2 {
        &self.pagelock2
    }
    #[doc = "0x12c - No Description"]
    #[inline(always)]
    pub const fn pagelock3(&self) -> &Pagelock3 {
        &self.pagelock3
    }
    #[doc = "0x130 - No Description"]
    #[inline(always)]
    pub const fn pagelock4(&self) -> &Pagelock4 {
        &self.pagelock4
    }
    #[doc = "0x134 - No Description"]
    #[inline(always)]
    pub const fn pagelock5(&self) -> &Pagelock5 {
        &self.pagelock5
    }
}
...
#[doc = "No Description"]
pub mod pagelock1;
#[doc = "PAGELOCK2 (rw) register accessor: No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`pagelock2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pagelock2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pagelock2`]
module"]
#[doc(alias = "PAGELOCK2")]
pub type Pagelock2 = crate::Reg<pagelock2::Pagelock2Spec>;
#[doc = "No Description"]
pub mod pagelock2;
#[doc = "PAGELOCK3 (rw) register accessor: No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`pagelock3::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pagelock3::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pagelock3`]
module"]
#[doc(alias = "PAGELOCK3")]
pub type Pagelock3 = crate::Reg<pagelock3::Pagelock3Spec>;
#[doc = "No Description"]
pub mod pagelock3;
#[doc = "PAGELOCK4 (rw) register accessor: No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`pagelock4::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pagelock4::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pagelock4`]
module"]
#[doc(alias = "PAGELOCK4")]
pub type Pagelock4 = crate::Reg<pagelock4::Pagelock4Spec>;
#[doc = "No Description"]
pub mod pagelock4;
#[doc = "PAGELOCK5 (rw) register accessor: No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`pagelock5::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pagelock5::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pagelock5`]
module"]
#[doc(alias = "PAGELOCK5")]
pub type Pagelock5 = crate::Reg<pagelock5::Pagelock5Spec>;
#[doc = "No Description"]
pub mod pagelock5;
