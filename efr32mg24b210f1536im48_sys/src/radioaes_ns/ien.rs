...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fetcherendofblock(&mut self) -> FetcherendofblockW<IenSpec> {
        FetcherendofblockW::new(self, 0)
    }
    #[doc = "Bit 1 - Stopped interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn fetcherstopped(&mut self) -> FetcherstoppedW<IenSpec> {
        FetcherstoppedW::new(self, 1)
    }
    #[doc = "Bit 2 - Error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn fetchererror(&mut self) -> FetchererrorW<IenSpec> {
        FetchererrorW::new(self, 2)
    }
    #[doc = "Bit 3 - End of block interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pusherendofblock(&mut self) -> PusherendofblockW<IenSpec> {
        PusherendofblockW::new(self, 3)
    }
    #[doc = "Bit 4 - Stopped interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pusherstopped(&mut self) -> PusherstoppedW<IenSpec> {
        PusherstoppedW::new(self, 4)
    }
    #[doc = "Bit 5 - Error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn pushererror(&mut self) -> PushererrorW<IenSpec> {
