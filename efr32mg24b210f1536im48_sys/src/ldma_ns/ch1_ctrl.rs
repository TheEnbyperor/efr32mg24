...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn structtype(&mut self) -> StructtypeW<Ch1CtrlSpec> {
        StructtypeW::new(self, 0)
    }
    #[doc = "Bits 4:14 - DMA Unit Data Transfer Count"]
    #[inline(always)]
    #[must_use]
    pub fn xfercnt(&mut self) -> XfercntW<Ch1CtrlSpec> {
        XfercntW::new(self, 4)
    }
    #[doc = "Bit 15 - Endian Byte Swap"]
    #[inline(always)]
    #[must_use]
    pub fn byteswap(&mut self) -> ByteswapW<Ch1CtrlSpec> {
        ByteswapW::new(self, 15)
    }
    #[doc = "Bits 16:19 - Block Transfer Size"]
    #[inline(always)]
    #[must_use]
    pub fn blocksize(&mut self) -> BlocksizeW<Ch1CtrlSpec> {
        BlocksizeW::new(self, 16)
    }
    #[doc = "Bit 20 - DMA Operation Done Interrupt Flag Set En"]
    #[inline(always)]
    #[must_use]
    pub fn doneien(&mut self) -> DoneienW<Ch1CtrlSpec> {
        DoneienW::new(self, 20)
    }
    #[doc = "Bit 21 - DMA Request Transfer Mode Select"]
    #[inline(always)]
    #[must_use]
    pub fn reqmode(&mut self) -> ReqmodeW<Ch1CtrlSpec> {
        ReqmodeW::new(self, 21)
    }
    #[doc = "Bit 22 - Decrement Loop Count"]
    #[inline(always)]
    #[must_use]
    pub fn decloopcnt(&mut self) -> DecloopcntW<Ch1CtrlSpec> {
        DecloopcntW::new(self, 22)
    }
    #[doc = "Bit 23 - Ignore Sreq"]
    #[inline(always)]
    #[must_use]
    pub fn ignoresreq(&mut self) -> IgnoresreqW<Ch1CtrlSpec> {
        IgnoresreqW::new(self, 23)
    }
    #[doc = "Bits 24:25 - Source Address Increment Size"]
    #[inline(always)]
    #[must_use]
    pub fn srcinc(&mut self) -> SrcincW<Ch1CtrlSpec> {
        SrcincW::new(self, 24)
    }
    #[doc = "Bits 26:27 - Unit Data Transfer Size"]
    #[inline(always)]
    #[must_use]
    pub fn size(&mut self) -> SizeW<Ch1CtrlSpec> {
        SizeW::new(self, 26)
    }
    #[doc = "Bits 28:29 - Destination Address Increment Size"]
    #[inline(always)]
    #[must_use]
    pub fn dstinc(&mut self) -> DstincW<Ch1CtrlSpec> {
        DstincW::new(self, 28)
    }
}
