...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn radioaes(&mut self) -> RadioaesW<Bmpunspatd0Spec> {
        RadioaesW::new(self, 0)
    }
    #[doc = "Bit 1 - RADIO subsystem manager privileged mode"]
    #[inline(always)]
    #[must_use]
    pub fn radiosubsystem(&mut self) -> RadiosubsystemW<Bmpunspatd0Spec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mvpahbdata0(&mut self) -> Mvpahbdata0W<Bmpunspatd0Spec> {
        Mvpahbdata0W::new(self, 3)
    }
    #[doc = "Bit 4 - MVPAHBDATA1 privileged mode"]
    #[inline(always)]
    #[must_use]
    pub fn mvpahbdata1(&mut self) -> Mvpahbdata1W<Bmpunspatd0Spec> {
        Mvpahbdata1W::new(self, 4)
    }
    #[doc = "Bit 5 - MVPAHBDATA2 privileged mode"]
    #[inline(always)]
    #[must_use]
    pub fn mvpahbdata2(&mut self) -> Mvpahbdata2W<Bmpunspatd0Spec> {
        Mvpahbdata2W::new(self, 5)
    }
    #[doc = "Bit 6 - RFECA0 privileged mode"]
    #[inline(always)]
    #[must_use]
    pub fn rfeca0(&mut self) -> Rfeca0W<Bmpunspatd0Spec> {
        Rfeca0W::new(self, 6)
    }
    #[doc = "Bit 7 - RFECA1 privileged mode"]
    #[inline(always)]
    #[must_use]
    pub fn rfeca1(&mut self) -> Rfeca1W<Bmpunspatd0Spec> {
        Rfeca1W::new(self, 7)
    }
    #[doc = "Bit 8 - SEEXTDMA privileged mode"]
    #[inline(always)]
