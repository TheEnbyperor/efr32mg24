...
pub enum Ahbportpriority {
    ...
    Port1 = 2,
    #[doc = "3: AHB port 2 has raised priority."]
    Port2 = 3,
    #[doc = "4: AHB port 3 has raised priority."]
    Port3 = 4,
}
...
impl AhbportpriorityR {
    ...
    pub const fn variant(&self) -> Option<Ahbportpriority> {
        match self.bits {
            ...
            3 => Some(Ahbportpriority::Port2),
            4 => Some(Ahbportpriority::Port3),
            _ => None,
        }
    }
    ...
    #[doc = "AHB port 2 has raised priority."]
    #[inline(always)]
    pub fn is_port2(&self) -> bool {
        *self == Ahbportpriority::Port2
    }
    #[doc = "AHB port 3 has raised priority."]
    #[inline(always)]
    pub fn is_port3(&self) -> bool {
        *self == Ahbportpriority::Port3
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "AHB port 2 has raised priority."]
    #[inline(always)]
    pub fn port2(self) -> &'a mut crate::W<REG> {
        self.variant(Ahbportpriority::Port2)
    }
    #[doc = "AHB port 3 has raised priority."]
    #[inline(always)]
    pub fn port3(self) -> &'a mut crate::W<REG> {
        self.variant(Ahbportpriority::Port3)
    }
}
...
#[doc = "Field `WAITSTATES` reader - RAM read wait states"]
pub type WaitstatesR = crate::BitReader;
#[doc = "Field `WAITSTATES` writer - RAM read wait states"]
pub type WaitstatesW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 7 - RAM read wait states"]
    #[inline(always)]
    pub fn waitstates(&self) -> WaitstatesR {
        WaitstatesR::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Enable ECC functionality"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn waitstates(&mut self) -> WaitstatesW<CtrlSpec> {
        WaitstatesW::new(self, 7)
    }
}
