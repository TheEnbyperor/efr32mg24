...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahb2err1b(&mut self) -> Ahb2err1bW<IfSpec> {
        Ahb2err1bW::new(self, 2)
    }
    #[doc = "Bit 3 - AHB3 1-bit ECC Error Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn ahb3err1b(&mut self) -> Ahb3err1bW<IfSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahb2err2b(&mut self) -> Ahb2err2bW<IfSpec> {
        Ahb2err2bW::new(self, 6)
    }
    #[doc = "Bit 7 - AHB3 2-bit ECC Error Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn ahb3err2b(&mut self) -> Ahb3err2bW<IfSpec> {
