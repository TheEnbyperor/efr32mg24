...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn outinv(&mut self) -> OutinvW<Cc1CtrlSpec> {
        OutinvW::new(self, 2)
    }
    #[doc = "Bits 8:9 - Compare Match Output Action"]
    #[inline(always)]
    #[must_use]
    pub fn cmoa(&mut self) -> CmoaW<Cc1CtrlSpec> {
        CmoaW::new(self, 8)
    }
    #[doc = "Bits 10:11 - Counter Overflow Output Action"]
    #[inline(always)]
    #[must_use]
    pub fn cofoa(&mut self) -> CofoaW<Cc1CtrlSpec> {
        CofoaW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Counter Underflow Output Action"]
    #[inline(always)]
    #[must_use]
    pub fn cufoa(&mut self) -> CufoaW<Cc1CtrlSpec> {
        CufoaW::new(self, 12)
    }
    #[doc = "Bits 24:25 - Input Capture Edge Select"]
    #[inline(always)]
    #[must_use]
    pub fn icedge(&mut self) -> IcedgeW<Cc1CtrlSpec> {
        IcedgeW::new(self, 24)
    }
    #[doc = "Bits 26:27 - Input Capture Event Control"]
    #[inline(always)]
    #[must_use]
    pub fn icevctrl(&mut self) -> IcevctrlW<Cc1CtrlSpec> {
