...
pub type R = crate::R<ConsumerSetamperTampersrc30Spec>;
#[doc = "Register `CONSUMER_SETAMPER_TAMPERSRC30` writer"]
pub type W = crate::W<ConsumerSetamperTampersrc30Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn prssel(&mut self) -> PrsselW<ConsumerSetamperTampersrc30Spec> {
        PrsselW::new(self, 0)
    }
}
...
pub struct ConsumerSetamperTampersrc30Spec;
...
impl crate::Readable for ConsumerSetamperTampersrc30Spec {}
#[doc = "`write(|w| ..)` method takes [`consumer_setamper_tampersrc30::W`](W) writer structure"]
impl crate::Writable for ConsumerSetamperTampersrc30Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CONSUMER_SETAMPER_TAMPERSRC30 to value 0"]
impl crate::Resettable for ConsumerSetamperTampersrc30Spec {
