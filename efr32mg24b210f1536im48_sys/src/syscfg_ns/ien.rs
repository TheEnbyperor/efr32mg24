...
#[doc = "Field `HOST2SRWBUSERR` reader - HOST2SRWBUSERRIEN Interrupt Enable"]
pub type Host2srwbuserrR = crate::BitReader;
#[doc = "Field `HOST2SRWBUSERR` writer - HOST2SRWBUSERRIEN Interrupt Enable"]
pub type Host2srwbuserrW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SRW2HOSTBUSERR` reader - SRW2HOSTBUSERRIEN Interrupt Enable"]
pub type Srw2hostbuserrR = crate::BitReader;
#[doc = "Field `SRW2HOSTBUSERR` writer - SRW2HOSTBUSERRIEN Interrupt Enable"]
...
impl R {
    ...
    #[doc = "Bit 16 - HOST2SRWBUSERRIEN Interrupt Enable"]
    #[inline(always)]
    pub fn host2srwbuserr(&self) -> Host2srwbuserrR {
        Host2srwbuserrR::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - SRW2HOSTBUSERRIEN Interrupt Enable"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn host2srwbuserr(&mut self) -> Host2srwbuserrW<IenSpec> {
        Host2srwbuserrW::new(self, 16)
    }
    #[doc = "Bit 17 - SRW2HOSTBUSERRIEN Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn srw2hostbuserr(&mut self) -> Srw2hostbuserrW<IenSpec> {
