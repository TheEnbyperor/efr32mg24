...
pub type R = crate::R<Cc2CfgSpec>;
#[doc = "Register `CC2_CFG` writer"]
pub type W = crate::W<Cc2CfgSpec>;
#[doc = "CC Channel Mode\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<Cc2CfgSpec> {
        ModeW::new(self, 0)
    }
    #[doc = "Bit 4 - Compare Output Initial State"]
    #[inline(always)]
    #[must_use]
    pub fn coist(&mut self) -> CoistW<Cc2CfgSpec> {
        CoistW::new(self, 4)
    }
    #[doc = "Bits 17:18 - Input Selection"]
    #[inline(always)]
    #[must_use]
    pub fn insel(&mut self) -> InselW<Cc2CfgSpec> {
        InselW::new(self, 17)
    }
    #[doc = "Bit 19 - PRS Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn prsconf(&mut self) -> PrsconfW<Cc2CfgSpec> {
        PrsconfW::new(self, 19)
    }
    #[doc = "Bit 20 - Digital Filter"]
    #[inline(always)]
    #[must_use]
    pub fn filt(&mut self) -> FiltW<Cc2CfgSpec> {
        FiltW::new(self, 20)
    }
    #[doc = "Bit 21 - Input Capture FIFO watermark level"]
    #[inline(always)]
    #[must_use]
    pub fn icfwl(&mut self) -> IcfwlW<Cc2CfgSpec> {
        IcfwlW::new(self, 21)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`cc2_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cc2_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cc2CfgSpec;
impl crate::RegisterSpec for Cc2CfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cc2_cfg::R`](R) reader structure"]
impl crate::Readable for Cc2CfgSpec {}
#[doc = "`write(|w| ..)` method takes [`cc2_cfg::W`](W) writer structure"]
impl crate::Writable for Cc2CfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CC2_CFG to value 0"]
impl crate::Resettable for Cc2CfgSpec {
