...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dalien(&mut self) -> DalienW<DalicfgSpec> {
        DalienW::new(self, 0)
    }
    #[doc = "Bits 1:5 - DALI TX Databits"]
    #[inline(always)]
    #[must_use]
    pub fn dalitxdatabits(&mut self) -> DalitxdatabitsW<DalicfgSpec> {
        DalitxdatabitsW::new(self, 1)
    }
    #[doc = "Bits 8:12 - DALI RX Databits"]
    #[inline(always)]
    #[must_use]
    pub fn dalirxdatabits(&mut self) -> DalirxdatabitsW<DalicfgSpec> {
        DalirxdatabitsW::new(self, 8)
    }
    #[doc = "Bit 15 - DALI RX Enabled During Transmission"]
    #[inline(always)]
    #[must_use]
    pub fn dalirxendt(&mut self) -> DalirxendtW<DalicfgSpec> {
