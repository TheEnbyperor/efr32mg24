...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkptloop0done(&mut self) -> Bkptloop0doneW<DebugenSpec> {
        Bkptloop0doneW::new(self, 1)
    }
    #[doc = "Bit 2 - Enable Breakpoint on Loop Done"]
    #[inline(always)]
    #[must_use]
    pub fn bkptloop1done(&mut self) -> Bkptloop1doneW<DebugenSpec> {
        Bkptloop1doneW::new(self, 2)
    }
    #[doc = "Bit 3 - Enable Breakpoint on Loop Done"]
    #[inline(always)]
    #[must_use]
    pub fn bkptloop2done(&mut self) -> Bkptloop2doneW<DebugenSpec> {
        Bkptloop2doneW::new(self, 3)
    }
    #[doc = "Bit 4 - Enable Breakpoint on Loop Done"]
    #[inline(always)]
    #[must_use]
    pub fn bkptloop3done(&mut self) -> Bkptloop3doneW<DebugenSpec> {
        Bkptloop3doneW::new(self, 4)
    }
    #[doc = "Bit 5 - Enable Breakpoint on Loop Done"]
    #[inline(always)]
    #[must_use]
    pub fn bkptloop4done(&mut self) -> Bkptloop4doneW<DebugenSpec> {
        Bkptloop4doneW::new(self, 5)
    }
    #[doc = "Bit 6 - Enable Breakpoint on Loop Done"]
    #[inline(always)]
    #[must_use]
    pub fn bkptloop5done(&mut self) -> Bkptloop5doneW<DebugenSpec> {
        Bkptloop5doneW::new(self, 6)
    }
    #[doc = "Bit 7 - Enable Breakpoint on Loop Done"]
    #[inline(always)]
    #[must_use]
    pub fn bkptloop6done(&mut self) -> Bkptloop6doneW<DebugenSpec> {
        Bkptloop6doneW::new(self, 7)
    }
    #[doc = "Bit 8 - Enable Breakpoint on Loop Done"]
    #[inline(always)]
    #[must_use]
    pub fn bkptloop7done(&mut self) -> Bkptloop7doneW<DebugenSpec> {
        Bkptloop7doneW::new(self, 8)
    }
    #[doc = "Bit 10 - Enable Breakpoint on ALUNAN"]
    #[inline(always)]
    #[must_use]
    pub fn bkptalunan(&mut self) -> BkptalunanW<DebugenSpec> {
        BkptalunanW::new(self, 10)
    }
    #[doc = "Bit 11 - Enable Breakpoint on R0POSREAL"]
    #[inline(always)]
    #[must_use]
    pub fn bkptr0posreal(&mut self) -> Bkptr0posrealW<DebugenSpec> {
        Bkptr0posrealW::new(self, 11)
    }
    #[doc = "Bit 12 - Enable Breakpoint on ALUOF"]
    #[inline(always)]
    #[must_use]
    pub fn bkptaluof(&mut self) -> BkptaluofW<DebugenSpec> {
        BkptaluofW::new(self, 12)
    }
    #[doc = "Bit 13 - Enable Breakpoint on ALUUF"]
    #[inline(always)]
    #[must_use]
    pub fn bkptaluuf(&mut self) -> BkptaluufW<DebugenSpec> {
        BkptaluufW::new(self, 13)
    }
    #[doc = "Bit 14 - Enable Breakpoint on STORECONVERTOF"]
    #[inline(always)]
    #[must_use]
    pub fn bkptstoreconvertof(&mut self) -> BkptstoreconvertofW<DebugenSpec> {
        BkptstoreconvertofW::new(self, 14)
    }
    #[doc = "Bit 15 - Enable Breakpoint on STORECONVERTUF"]
    #[inline(always)]
    #[must_use]
    pub fn bkptstoreconvertuf(&mut self) -> BkptstoreconvertufW<DebugenSpec> {
        BkptstoreconvertufW::new(self, 15)
    }
    #[doc = "Bit 16 - Enable Breakpoint on STORECONVERTINF"]
    #[inline(always)]
    #[must_use]
    pub fn bkptstoreconvertinf(&mut self) -> BkptstoreconvertinfW<DebugenSpec> {
        BkptstoreconvertinfW::new(self, 16)
    }
    #[doc = "Bit 17 - Enable Breakpoint on STORECONVERTNAN"]
    #[inline(always)]
    #[must_use]
    pub fn bkptstoreconvertnan(&mut self) -> BkptstoreconvertnanW<DebugenSpec> {
        BkptstoreconvertnanW::new(self, 17)
    }
    #[doc = "Bit 28 - Debug Step Count Enable"]
    #[inline(always)]
    #[must_use]
    pub fn debugstepcnten(&mut self) -> DebugstepcntenW<DebugenSpec> {
        DebugstepcntenW::new(self, 28)
    }
    #[doc = "Bit 29 - Trigger Breakpoint when ALL conditions match"]
    #[inline(always)]
    #[must_use]
    pub fn debugbkptallen(&mut self) -> DebugbkptallenW<DebugenSpec> {
        DebugbkptallenW::new(self, 29)
    }
    #[doc = "Bit 30 - Enable Breakpoint when ANY conditions match"]
    #[inline(always)]
    #[must_use]
    pub fn debugbkptanyen(&mut self) -> DebugbkptanyenW<DebugenSpec> {
