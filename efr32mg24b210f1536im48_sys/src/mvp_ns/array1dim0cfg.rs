#[doc = "Register `ARRAY1DIM0CFG` reader"]
pub type R = crate::R<Array1dim0cfgSpec>;
#[doc = "Register `ARRAY1DIM0CFG` writer"]
pub type W = crate::W<Array1dim0cfgSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn size(&mut self) -> SizeW<Array1dim0cfgSpec> {
        SizeW::new(self, 0)
    }
    #[doc = "Bits 12:13 - Element Type"]
    #[inline(always)]
    #[must_use]
    pub fn basetype(&mut self) -> BasetypeW<Array1dim0cfgSpec> {
        BasetypeW::new(self, 12)
    }
    #[doc = "Bit 14 - Complex Data Type"]
    #[inline(always)]
    #[must_use]
    pub fn complex(&mut self) -> ComplexW<Array1dim0cfgSpec> {
        ComplexW::new(self, 14)
    }
    #[doc = "Bits 16:27 - Dimension Stride Step"]
    #[inline(always)]
    #[must_use]
    pub fn stride(&mut self) -> StrideW<Array1dim0cfgSpec> {
        StrideW::new(self, 16)
    }
}
#[doc = "Array N Dimenion 0 Configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`array1dim0cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`array1dim0cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Array1dim0cfgSpec;
impl crate::RegisterSpec for Array1dim0cfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`array1dim0cfg::R`](R) reader structure"]
impl crate::Readable for Array1dim0cfgSpec {}
#[doc = "`write(|w| ..)` method takes [`array1dim0cfg::W`](W) writer structure"]
impl crate::Writable for Array1dim0cfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ARRAY1DIM0CFG to value 0x2000"]
impl crate::Resettable for Array1dim0cfgSpec {
