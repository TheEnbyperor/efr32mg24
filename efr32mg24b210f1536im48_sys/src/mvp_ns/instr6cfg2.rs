#[doc = "Register `INSTR6CFG2` reader"]
pub type R = crate::R<Instr6cfg2Spec>;
#[doc = "Register `INSTR6CFG2` writer"]
pub type W = crate::W<Instr6cfg2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn loop0begin(&mut self) -> Loop0beginW<Instr6cfg2Spec> {
        Loop0beginW::new(self, 0)
    }
    #[doc = "Bit 1 - Loop End"]
    #[inline(always)]
    #[must_use]
    pub fn loop0end(&mut self) -> Loop0endW<Instr6cfg2Spec> {
        Loop0endW::new(self, 1)
    }
    #[doc = "Bit 2 - Loop Begin"]
    #[inline(always)]
    #[must_use]
    pub fn loop1begin(&mut self) -> Loop1beginW<Instr6cfg2Spec> {
        Loop1beginW::new(self, 2)
    }
    #[doc = "Bit 3 - Loop End"]
    #[inline(always)]
    #[must_use]
    pub fn loop1end(&mut self) -> Loop1endW<Instr6cfg2Spec> {
        Loop1endW::new(self, 3)
    }
    #[doc = "Bit 4 - Loop Begin"]
    #[inline(always)]
    #[must_use]
    pub fn loop2begin(&mut self) -> Loop2beginW<Instr6cfg2Spec> {
        Loop2beginW::new(self, 4)
    }
    #[doc = "Bit 5 - Loop End"]
    #[inline(always)]
    #[must_use]
    pub fn loop2end(&mut self) -> Loop2endW<Instr6cfg2Spec> {
        Loop2endW::new(self, 5)
    }
    #[doc = "Bit 6 - Loop Begin"]
    #[inline(always)]
    #[must_use]
    pub fn loop3begin(&mut self) -> Loop3beginW<Instr6cfg2Spec> {
        Loop3beginW::new(self, 6)
    }
    #[doc = "Bit 7 - Loop End"]
    #[inline(always)]
    #[must_use]
    pub fn loop3end(&mut self) -> Loop3endW<Instr6cfg2Spec> {
        Loop3endW::new(self, 7)
    }
    #[doc = "Bit 8 - Loop Begin"]
    #[inline(always)]
    #[must_use]
    pub fn loop4begin(&mut self) -> Loop4beginW<Instr6cfg2Spec> {
        Loop4beginW::new(self, 8)
    }
    #[doc = "Bit 9 - Loop End"]
    #[inline(always)]
    #[must_use]
    pub fn loop4end(&mut self) -> Loop4endW<Instr6cfg2Spec> {
        Loop4endW::new(self, 9)
    }
    #[doc = "Bit 10 - Loop Begin"]
    #[inline(always)]
    #[must_use]
    pub fn loop5begin(&mut self) -> Loop5beginW<Instr6cfg2Spec> {
        Loop5beginW::new(self, 10)
    }
    #[doc = "Bit 11 - Loop End"]
    #[inline(always)]
    #[must_use]
    pub fn loop5end(&mut self) -> Loop5endW<Instr6cfg2Spec> {
        Loop5endW::new(self, 11)
    }
    #[doc = "Bit 12 - Loop Begin"]
    #[inline(always)]
    #[must_use]
    pub fn loop6begin(&mut self) -> Loop6beginW<Instr6cfg2Spec> {
        Loop6beginW::new(self, 12)
    }
    #[doc = "Bit 13 - Loop End"]
    #[inline(always)]
    #[must_use]
    pub fn loop6end(&mut self) -> Loop6endW<Instr6cfg2Spec> {
        Loop6endW::new(self, 13)
    }
    #[doc = "Bit 14 - Loop Begin"]
    #[inline(always)]
    #[must_use]
    pub fn loop7begin(&mut self) -> Loop7beginW<Instr6cfg2Spec> {
        Loop7beginW::new(self, 14)
    }
    #[doc = "Bit 15 - Loop End"]
    #[inline(always)]
    #[must_use]
    pub fn loop7end(&mut self) -> Loop7endW<Instr6cfg2Spec> {
        Loop7endW::new(self, 15)
    }
    #[doc = "Bits 20:28 - ALU opcode"]
    #[inline(always)]
    #[must_use]
    pub fn aluop(&mut self) -> AluopW<Instr6cfg2Spec> {
        AluopW::new(self, 20)
    }
    #[doc = "Bit 31 - End of Program"]
    #[inline(always)]
    #[must_use]
    pub fn endprog(&mut self) -> EndprogW<Instr6cfg2Spec> {
        EndprogW::new(self, 31)
    }
}
#[doc = "Instruction N word 2\n\nYou can [`read`](crate::Reg::read) this register and get [`instr6cfg2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`instr6cfg2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Instr6cfg2Spec;
impl crate::RegisterSpec for Instr6cfg2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`instr6cfg2::R`](R) reader structure"]
impl crate::Readable for Instr6cfg2Spec {}
#[doc = "`write(|w| ..)` method takes [`instr6cfg2::W`](W) writer structure"]
impl crate::Writable for Instr6cfg2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INSTR6CFG2 to value 0"]
impl crate::Resettable for Instr6cfg2Spec {
