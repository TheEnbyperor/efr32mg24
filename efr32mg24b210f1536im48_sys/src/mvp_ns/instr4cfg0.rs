#[doc = "Register `INSTR4CFG0` reader"]
pub type R = crate::R<Instr4cfg0Spec>;
#[doc = "Register `INSTR4CFG0` writer"]
pub type W = crate::W<Instr4cfg0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aluin0regid(&mut self) -> Aluin0regidW<Instr4cfg0Spec> {
        Aluin0regidW::new(self, 0)
    }
    #[doc = "Bit 4 - Real Zero"]
    #[inline(always)]
    #[must_use]
    pub fn aluin0realzero(&mut self) -> Aluin0realzeroW<Instr4cfg0Spec> {
        Aluin0realzeroW::new(self, 4)
    }
    #[doc = "Bit 5 - Real Negate"]
    #[inline(always)]
    #[must_use]
    pub fn aluin0realnegate(&mut self) -> Aluin0realnegateW<Instr4cfg0Spec> {
        Aluin0realnegateW::new(self, 5)
    }
    #[doc = "Bit 6 - Imaginary Not Zero"]
    #[inline(always)]
    #[must_use]
    pub fn aluin0imagzero(&mut self) -> Aluin0imagzeroW<Instr4cfg0Spec> {
        Aluin0imagzeroW::new(self, 6)
    }
    #[doc = "Bit 7 - Imaginary Negate"]
    #[inline(always)]
    #[must_use]
    pub fn aluin0imagnegate(&mut self) -> Aluin0imagnegateW<Instr4cfg0Spec> {
        Aluin0imagnegateW::new(self, 7)
    }
    #[doc = "Bits 8:10 - Register ID"]
    #[inline(always)]
    #[must_use]
    pub fn aluin1regid(&mut self) -> Aluin1regidW<Instr4cfg0Spec> {
        Aluin1regidW::new(self, 8)
    }
    #[doc = "Bit 12 - Real Zero"]
    #[inline(always)]
    #[must_use]
    pub fn aluin1realzero(&mut self) -> Aluin1realzeroW<Instr4cfg0Spec> {
        Aluin1realzeroW::new(self, 12)
    }
    #[doc = "Bit 13 - Real Negate"]
    #[inline(always)]
    #[must_use]
    pub fn aluin1realnegate(&mut self) -> Aluin1realnegateW<Instr4cfg0Spec> {
        Aluin1realnegateW::new(self, 13)
    }
    #[doc = "Bit 14 - Imaginary Not Zero"]
    #[inline(always)]
    #[must_use]
    pub fn aluin1imagzero(&mut self) -> Aluin1imagzeroW<Instr4cfg0Spec> {
        Aluin1imagzeroW::new(self, 14)
    }
    #[doc = "Bit 15 - Imaginary Negate"]
    #[inline(always)]
    #[must_use]
    pub fn aluin1imagnegate(&mut self) -> Aluin1imagnegateW<Instr4cfg0Spec> {
        Aluin1imagnegateW::new(self, 15)
    }
    #[doc = "Bits 16:18 - Register ID"]
    #[inline(always)]
    #[must_use]
    pub fn aluin2regid(&mut self) -> Aluin2regidW<Instr4cfg0Spec> {
        Aluin2regidW::new(self, 16)
    }
    #[doc = "Bit 20 - Real Zero"]
    #[inline(always)]
    #[must_use]
    pub fn aluin2realzero(&mut self) -> Aluin2realzeroW<Instr4cfg0Spec> {
        Aluin2realzeroW::new(self, 20)
    }
    #[doc = "Bit 21 - Real Negate"]
    #[inline(always)]
    #[must_use]
    pub fn aluin2realnegate(&mut self) -> Aluin2realnegateW<Instr4cfg0Spec> {
        Aluin2realnegateW::new(self, 21)
    }
    #[doc = "Bit 22 - Imaginary Not Zero"]
    #[inline(always)]
    #[must_use]
    pub fn aluin2imagzero(&mut self) -> Aluin2imagzeroW<Instr4cfg0Spec> {
        Aluin2imagzeroW::new(self, 22)
    }
    #[doc = "Bit 23 - Imaginary Negate"]
    #[inline(always)]
    #[must_use]
    pub fn aluin2imagnegate(&mut self) -> Aluin2imagnegateW<Instr4cfg0Spec> {
        Aluin2imagnegateW::new(self, 23)
    }
    #[doc = "Bits 28:30 - Register ID"]
    #[inline(always)]
    #[must_use]
    pub fn aluoutregid(&mut self) -> AluoutregidW<Instr4cfg0Spec> {
        AluoutregidW::new(self, 28)
    }
}
#[doc = "Instruction N Word 0\n\nYou can [`read`](crate::Reg::read) this register and get [`instr4cfg0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`instr4cfg0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Instr4cfg0Spec;
impl crate::RegisterSpec for Instr4cfg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`instr4cfg0::R`](R) reader structure"]
impl crate::Readable for Instr4cfg0Spec {}
#[doc = "`write(|w| ..)` method takes [`instr4cfg0::W`](W) writer structure"]
impl crate::Writable for Instr4cfg0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INSTR4CFG0 to value 0"]
impl crate::Resettable for Instr4cfg0Spec {
