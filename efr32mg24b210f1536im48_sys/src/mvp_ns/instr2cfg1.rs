#[doc = "Register `INSTR2CFG1` reader"]
pub type R = crate::R<Instr2cfg1Spec>;
#[doc = "Register `INSTR2CFG1` writer"]
pub type W = crate::W<Instr2cfg1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn istream0regid(&mut self) -> Istream0regidW<Instr2cfg1Spec> {
        Istream0regidW::new(self, 0)
    }
    #[doc = "Bit 3 - Load register"]
    #[inline(always)]
    #[must_use]
    pub fn istream0load(&mut self) -> Istream0loadW<Instr2cfg1Spec> {
        Istream0loadW::new(self, 3)
    }
    #[doc = "Bits 4:6 - Array ID"]
    #[inline(always)]
    #[must_use]
    pub fn istream0arrayid(&mut self) -> Istream0arrayidW<Instr2cfg1Spec> {
        Istream0arrayidW::new(self, 4)
    }
    #[doc = "Bit 7 - Increment Array Dimension 0"]
    #[inline(always)]
    #[must_use]
    pub fn istream0arrayincrdim0(&mut self) -> Istream0arrayincrdim0W<Instr2cfg1Spec> {
        Istream0arrayincrdim0W::new(self, 7)
    }
    #[doc = "Bit 8 - Increment Array Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn istream0arrayincrdim1(&mut self) -> Istream0arrayincrdim1W<Instr2cfg1Spec> {
        Istream0arrayincrdim1W::new(self, 8)
    }
    #[doc = "Bit 9 - Increment Array Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn istream0arrayincrdim2(&mut self) -> Istream0arrayincrdim2W<Instr2cfg1Spec> {
        Istream0arrayincrdim2W::new(self, 9)
    }
    #[doc = "Bits 10:12 - Register ID"]
    #[inline(always)]
    #[must_use]
    pub fn istream1regid(&mut self) -> Istream1regidW<Instr2cfg1Spec> {
        Istream1regidW::new(self, 10)
    }
    #[doc = "Bit 13 - Load register"]
    #[inline(always)]
    #[must_use]
    pub fn istream1load(&mut self) -> Istream1loadW<Instr2cfg1Spec> {
        Istream1loadW::new(self, 13)
    }
    #[doc = "Bits 14:16 - Array ID"]
    #[inline(always)]
    #[must_use]
    pub fn istream1arrayid(&mut self) -> Istream1arrayidW<Instr2cfg1Spec> {
        Istream1arrayidW::new(self, 14)
    }
    #[doc = "Bit 17 - Increment Array Dimension 0"]
    #[inline(always)]
    #[must_use]
    pub fn istream1arrayincrdim0(&mut self) -> Istream1arrayincrdim0W<Instr2cfg1Spec> {
        Istream1arrayincrdim0W::new(self, 17)
    }
    #[doc = "Bit 18 - Increment Array Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn istream1arrayincrdim1(&mut self) -> Istream1arrayincrdim1W<Instr2cfg1Spec> {
        Istream1arrayincrdim1W::new(self, 18)
    }
    #[doc = "Bit 19 - Increment Array Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn istream1arrayincrdim2(&mut self) -> Istream1arrayincrdim2W<Instr2cfg1Spec> {
        Istream1arrayincrdim2W::new(self, 19)
    }
    #[doc = "Bits 20:22 - Register ID"]
    #[inline(always)]
    #[must_use]
    pub fn ostreamregid(&mut self) -> OstreamregidW<Instr2cfg1Spec> {
        OstreamregidW::new(self, 20)
    }
    #[doc = "Bit 23 - Store to Register"]
    #[inline(always)]
    #[must_use]
    pub fn ostreamstore(&mut self) -> OstreamstoreW<Instr2cfg1Spec> {
        OstreamstoreW::new(self, 23)
    }
    #[doc = "Bits 24:26 - Array ID"]
    #[inline(always)]
    #[must_use]
    pub fn ostreamarrayid(&mut self) -> OstreamarrayidW<Instr2cfg1Spec> {
        OstreamarrayidW::new(self, 24)
    }
    #[doc = "Bit 27 - Increment Array Dimension 0"]
    #[inline(always)]
    #[must_use]
    pub fn ostreamarrayincrdim0(&mut self) -> Ostreamarrayincrdim0W<Instr2cfg1Spec> {
        Ostreamarrayincrdim0W::new(self, 27)
    }
    #[doc = "Bit 28 - Increment Array Dimension 1"]
    #[inline(always)]
    #[must_use]
    pub fn ostreamarrayincrdim1(&mut self) -> Ostreamarrayincrdim1W<Instr2cfg1Spec> {
        Ostreamarrayincrdim1W::new(self, 28)
    }
    #[doc = "Bit 29 - Increment Array Dimension 2"]
    #[inline(always)]
    #[must_use]
    pub fn ostreamarrayincrdim2(&mut self) -> Ostreamarrayincrdim2W<Instr2cfg1Spec> {
        Ostreamarrayincrdim2W::new(self, 29)
    }
}
#[doc = "Instruction N word 1\n\nYou can [`read`](crate::Reg::read) this register and get [`instr2cfg1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`instr2cfg1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Instr2cfg1Spec;
impl crate::RegisterSpec for Instr2cfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`instr2cfg1::R`](R) reader structure"]
impl crate::Readable for Instr2cfg1Spec {}
#[doc = "`write(|w| ..)` method takes [`instr2cfg1::W`](W) writer structure"]
impl crate::Writable for Instr2cfg1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INSTR2CFG1 to value 0"]
impl crate::Resettable for Instr2cfg1Spec {
