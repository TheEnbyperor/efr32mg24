...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn progdone(&mut self) -> ProgdoneW<IenSpec> {
        ProgdoneW::new(self, 0)
    }
    #[doc = "Bit 1 - Loop Done Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn loop0done(&mut self) -> Loop0doneW<IenSpec> {
        Loop0doneW::new(self, 1)
    }
    #[doc = "Bit 2 - Loop Done Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn loop1done(&mut self) -> Loop1doneW<IenSpec> {
        Loop1doneW::new(self, 2)
    }
    #[doc = "Bit 3 - Loop Done Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn loop2done(&mut self) -> Loop2doneW<IenSpec> {
        Loop2doneW::new(self, 3)
    }
    #[doc = "Bit 4 - Loop Done Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn loop3done(&mut self) -> Loop3doneW<IenSpec> {
        Loop3doneW::new(self, 4)
    }
    #[doc = "Bit 5 - Loop Done Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn loop4done(&mut self) -> Loop4doneW<IenSpec> {
        Loop4doneW::new(self, 5)
    }
    #[doc = "Bit 6 - Loop Done Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn loop5done(&mut self) -> Loop5doneW<IenSpec> {
        Loop5doneW::new(self, 6)
    }
    #[doc = "Bit 7 - Loop Done Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn loop6done(&mut self) -> Loop6doneW<IenSpec> {
        Loop6doneW::new(self, 7)
    }
    #[doc = "Bit 8 - Loop Done Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn loop7done(&mut self) -> Loop7doneW<IenSpec> {
        Loop7doneW::new(self, 8)
    }
    #[doc = "Bit 10 - Not-a-Number Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn alunan(&mut self) -> AlunanW<IenSpec> {
        AlunanW::new(self, 10)
    }
    #[doc = "Bit 11 - R0 Non-Zero Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn r0posreal(&mut self) -> R0posrealW<IenSpec> {
        R0posrealW::new(self, 11)
    }
    #[doc = "Bit 12 - ALU Overflow Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn aluof(&mut self) -> AluofW<IenSpec> {
        AluofW::new(self, 12)
    }
    #[doc = "Bit 13 - ALU Underflow Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn aluuf(&mut self) -> AluufW<IenSpec> {
        AluufW::new(self, 13)
    }
    #[doc = "Bit 14 - Store conversion Overflow Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn storeconvertof(&mut self) -> StoreconvertofW<IenSpec> {
        StoreconvertofW::new(self, 14)
    }
    #[doc = "Bit 15 - Store Conversion Underflow Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn storeconvertuf(&mut self) -> StoreconvertufW<IenSpec> {
        StoreconvertufW::new(self, 15)
    }
    #[doc = "Bit 16 - Store Conversion Infinity Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn storeconvertinf(&mut self) -> StoreconvertinfW<IenSpec> {
        StoreconvertinfW::new(self, 16)
    }
    #[doc = "Bit 17 - Store Conversion NaN Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn storeconvertnan(&mut self) -> StoreconvertnanW<IenSpec> {
        StoreconvertnanW::new(self, 17)
    }
    #[doc = "Bit 18 - Perf Counter 0 Overflow Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn perfcnt0(&mut self) -> Perfcnt0W<IenSpec> {
        Perfcnt0W::new(self, 18)
    }
    #[doc = "Bit 19 - Perf Counter 1 Overflow Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn perfcnt1(&mut self) -> Perfcnt1W<IenSpec> {
        Perfcnt1W::new(self, 19)
    }
    #[doc = "Bit 24 - Loop Fault Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn loopfault(&mut self) -> LoopfaultW<IenSpec> {
        LoopfaultW::new(self, 24)
    }
    #[doc = "Bit 25 - Bus Error Fault Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn buserrfault(&mut self) -> BuserrfaultW<IenSpec> {
        BuserrfaultW::new(self, 25)
    }
    #[doc = "Bit 26 - Bus Alignment Fault Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn busalignfault(&mut self) -> BusalignfaultW<IenSpec> {
        BusalignfaultW::new(self, 26)
    }
    #[doc = "Bit 27 - ALU Input Fault Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn alufault(&mut self) -> AlufaultW<IenSpec> {
        AlufaultW::new(self, 27)
    }
    #[doc = "Bit 28 - Array Fault Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn arrayfault(&mut self) -> ArrayfaultW<IenSpec> {
