...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn progdone(&mut self) -> ProgdoneW<IfSpec> {
        ProgdoneW::new(self, 0)
    }
    #[doc = "Bit 1 - Loop Done Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn loop0done(&mut self) -> Loop0doneW<IfSpec> {
        Loop0doneW::new(self, 1)
    }
    #[doc = "Bit 2 - Loop Done Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn loop1done(&mut self) -> Loop1doneW<IfSpec> {
        Loop1doneW::new(self, 2)
    }
    #[doc = "Bit 3 - Loop Done Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn loop2done(&mut self) -> Loop2doneW<IfSpec> {
        Loop2doneW::new(self, 3)
    }
    #[doc = "Bit 4 - Loop Done Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn loop3done(&mut self) -> Loop3doneW<IfSpec> {
        Loop3doneW::new(self, 4)
    }
    #[doc = "Bit 5 - Loop Done Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn loop4done(&mut self) -> Loop4doneW<IfSpec> {
        Loop4doneW::new(self, 5)
    }
    #[doc = "Bit 6 - Loop Done Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn loop5done(&mut self) -> Loop5doneW<IfSpec> {
        Loop5doneW::new(self, 6)
    }
    #[doc = "Bit 7 - Loop Done Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn loop6done(&mut self) -> Loop6doneW<IfSpec> {
        Loop6doneW::new(self, 7)
    }
    #[doc = "Bit 8 - Loop Done Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn loop7done(&mut self) -> Loop7doneW<IfSpec> {
        Loop7doneW::new(self, 8)
    }
    #[doc = "Bit 10 - Not-a-Number Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn alunan(&mut self) -> AlunanW<IfSpec> {
        AlunanW::new(self, 10)
    }
    #[doc = "Bit 11 - R0 non-zero Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn r0posreal(&mut self) -> R0posrealW<IfSpec> {
        R0posrealW::new(self, 11)
    }
    #[doc = "Bit 12 - ALU Overflow on result"]
    #[inline(always)]
    #[must_use]
    pub fn aluof(&mut self) -> AluofW<IfSpec> {
        AluofW::new(self, 12)
    }
    #[doc = "Bit 13 - ALU Underflow on result"]
    #[inline(always)]
    #[must_use]
    pub fn aluuf(&mut self) -> AluufW<IfSpec> {
        AluufW::new(self, 13)
    }
    #[doc = "Bit 14 - Overflow during array store"]
    #[inline(always)]
    #[must_use]
    pub fn storeconvertof(&mut self) -> StoreconvertofW<IfSpec> {
        StoreconvertofW::new(self, 14)
    }
    #[doc = "Bit 15 - Underflow during array store conversion"]
    #[inline(always)]
    #[must_use]
    pub fn storeconvertuf(&mut self) -> StoreconvertufW<IfSpec> {
        StoreconvertufW::new(self, 15)
    }
    #[doc = "Bit 16 - Infinity encountered during array store conversion"]
    #[inline(always)]
    #[must_use]
    pub fn storeconvertinf(&mut self) -> StoreconvertinfW<IfSpec> {
        StoreconvertinfW::new(self, 16)
    }
    #[doc = "Bit 17 - NaN encountered during array store conversion"]
    #[inline(always)]
    #[must_use]
    pub fn storeconvertnan(&mut self) -> StoreconvertnanW<IfSpec> {
        StoreconvertnanW::new(self, 17)
    }
    #[doc = "Bit 18 - Run Count Overflow Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn perfcnt0(&mut self) -> Perfcnt0W<IfSpec> {
        Perfcnt0W::new(self, 18)
    }
    #[doc = "Bit 19 - Stall Count Overflow Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn perfcnt1(&mut self) -> Perfcnt1W<IfSpec> {
        Perfcnt1W::new(self, 19)
    }
    #[doc = "Bit 24 - Loop Fault Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn loopfault(&mut self) -> LoopfaultW<IfSpec> {
        LoopfaultW::new(self, 24)
    }
    #[doc = "Bit 25 - Bus Error Fault Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn buserrfault(&mut self) -> BuserrfaultW<IfSpec> {
        BuserrfaultW::new(self, 25)
    }
    #[doc = "Bit 26 - Bus Alignment Fault Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn busalignfault(&mut self) -> BusalignfaultW<IfSpec> {
        BusalignfaultW::new(self, 26)
    }
    #[doc = "Bit 27 - ALU Fault Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn alufault(&mut self) -> AlufaultW<IfSpec> {
        AlufaultW::new(self, 27)
    }
    #[doc = "Bit 28 - Array Fault Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn arrayfault(&mut self) -> ArrayfaultW<IfSpec> {
