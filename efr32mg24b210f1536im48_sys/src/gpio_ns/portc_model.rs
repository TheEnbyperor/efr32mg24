...
pub type R = crate::R<PortcModelSpec>;
#[doc = "Register `PORTC_MODEL` writer"]
pub type W = crate::W<PortcModelSpec>;
#[doc = "MODE n\n\nValue on reset: 0"]
...
#[doc = "mode low\n\nYou can [`read`](crate::Reg::read) this register and get [`portc_model::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`portc_model::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PortcModelSpec;
impl crate::RegisterSpec for PortcModelSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`portc_model::R`](R) reader structure"]
impl crate::Readable for PortcModelSpec {}
