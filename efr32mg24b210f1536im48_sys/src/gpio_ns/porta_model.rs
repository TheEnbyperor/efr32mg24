...
pub type R = crate::R<PortaModelSpec>;
#[doc = "Register `PORTA_MODEL` writer"]
pub type W = crate::W<PortaModelSpec>;
#[doc = "MODE n\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mode0(&mut self) -> Mode0W<PortaModelSpec> {
        Mode0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - MODE n"]
    #[inline(always)]
    #[must_use]
    pub fn mode1(&mut self) -> Mode1W<PortaModelSpec> {
        Mode1W::new(self, 4)
    }
    #[doc = "Bits 8:11 - MODE n"]
    #[inline(always)]
    #[must_use]
    pub fn mode2(&mut self) -> Mode2W<PortaModelSpec> {
        Mode2W::new(self, 8)
    }
    #[doc = "Bits 12:15 - MODE n"]
    #[inline(always)]
    #[must_use]
    pub fn mode3(&mut self) -> Mode3W<PortaModelSpec> {
        Mode3W::new(self, 12)
    }
    #[doc = "Bits 16:19 - MODE n"]
    #[inline(always)]
    #[must_use]
    pub fn mode4(&mut self) -> Mode4W<PortaModelSpec> {
        Mode4W::new(self, 16)
    }
    #[doc = "Bits 20:23 - MODE n"]
    #[inline(always)]
    #[must_use]
    pub fn mode5(&mut self) -> Mode5W<PortaModelSpec> {
        Mode5W::new(self, 20)
    }
    #[doc = "Bits 24:27 - MODE n"]
    #[inline(always)]
    #[must_use]
    pub fn mode6(&mut self) -> Mode6W<PortaModelSpec> {
        Mode6W::new(self, 24)
    }
    #[doc = "Bits 28:31 - MODE n"]
    #[inline(always)]
    #[must_use]
    pub fn mode7(&mut self) -> Mode7W<PortaModelSpec> {
        Mode7W::new(self, 28)
    }
}
#[doc = "mode low\n\nYou can [`read`](crate::Reg::read) this register and get [`porta_model::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`porta_model::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PortaModelSpec;
impl crate::RegisterSpec for PortaModelSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`porta_model::R`](R) reader structure"]
impl crate::Readable for PortaModelSpec {}
#[doc = "`write(|w| ..)` method takes [`porta_model::W`](W) writer structure"]
impl crate::Writable for PortaModelSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PORTA_MODEL to value 0"]
impl crate::Resettable for PortaModelSpec {
