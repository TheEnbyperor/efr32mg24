...
pub type R = crate::R<Timer3Cc2routeSpec>;
#[doc = "Register `TIMER3_CC2ROUTE` writer"]
pub type W = crate::W<Timer3Cc2routeSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn port(&mut self) -> PortW<Timer3Cc2routeSpec> {
        PortW::new(self, 0)
    }
    #[doc = "Bits 16:19 - CC2 pin select register"]
    #[inline(always)]
    #[must_use]
    pub fn pin(&mut self) -> PinW<Timer3Cc2routeSpec> {
        PinW::new(self, 16)
    }
}
...
pub struct Timer3Cc2routeSpec;
impl crate::RegisterSpec for Timer3Cc2routeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timer3_cc2route::R`](R) reader structure"]
impl crate::Readable for Timer3Cc2routeSpec {}
#[doc = "`write(|w| ..)` method takes [`timer3_cc2route::W`](W) writer structure"]
impl crate::Writable for Timer3Cc2routeSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TIMER3_CC2ROUTE to value 0"]
impl crate::Resettable for Timer3Cc2routeSpec {
