...
#[doc = "Field `ASYNCH12PEN` reader - ASYNCH12 pin enable control bit"]
pub type Asynch12penR = crate::BitReader;
#[doc = "Field `ASYNCH12PEN` writer - ASYNCH12 pin enable control bit"]
pub type Asynch12penW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ASYNCH13PEN` reader - ASYNCH13 pin enable control bit"]
pub type Asynch13penR = crate::BitReader;
#[doc = "Field `ASYNCH13PEN` writer - ASYNCH13 pin enable control bit"]
pub type Asynch13penW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ASYNCH14PEN` reader - ASYNCH14 pin enable control bit"]
pub type Asynch14penR = crate::BitReader;
#[doc = "Field `ASYNCH14PEN` writer - ASYNCH14 pin enable control bit"]
pub type Asynch14penW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ASYNCH15PEN` reader - ASYNCH15 pin enable control bit"]
pub type Asynch15penR = crate::BitReader;
#[doc = "Field `ASYNCH15PEN` writer - ASYNCH15 pin enable control bit"]
pub type Asynch15penW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 12 - ASYNCH12 pin enable control bit"]
    #[inline(always)]
    pub fn asynch12pen(&self) -> Asynch12penR {
        Asynch12penR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - ASYNCH13 pin enable control bit"]
    #[inline(always)]
    pub fn asynch13pen(&self) -> Asynch13penR {
        Asynch13penR::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - ASYNCH14 pin enable control bit"]
    #[inline(always)]
    pub fn asynch14pen(&self) -> Asynch14penR {
        Asynch14penR::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - ASYNCH15 pin enable control bit"]
    #[inline(always)]
    pub fn asynch15pen(&self) -> Asynch15penR {
        Asynch15penR::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - SYNCH0 pin enable control bit"]
    #[inline(always)]
    pub fn synch0pen(&self) -> Synch0penR {
        Synch0penR::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - SYNCH1 pin enable control bit"]
    #[inline(always)]
    pub fn synch1pen(&self) -> Synch1penR {
        Synch1penR::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - SYNCH2 pin enable control bit"]
    #[inline(always)]
    pub fn synch2pen(&self) -> Synch2penR {
        Synch2penR::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - SYNCH3 pin enable control bit"]
    #[inline(always)]
    pub fn synch3pen(&self) -> Synch3penR {
        Synch3penR::new(((self.bits >> 19) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - ASYNCH0 pin enable control bit"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn asynch12pen(&mut self) -> Asynch12penW<Prs0RouteenSpec> {
        Asynch12penW::new(self, 12)
    }
    #[doc = "Bit 13 - ASYNCH13 pin enable control bit"]
    #[inline(always)]
    #[must_use]
    pub fn asynch13pen(&mut self) -> Asynch13penW<Prs0RouteenSpec> {
        Asynch13penW::new(self, 13)
    }
    #[doc = "Bit 14 - ASYNCH14 pin enable control bit"]
    #[inline(always)]
    #[must_use]
    pub fn asynch14pen(&mut self) -> Asynch14penW<Prs0RouteenSpec> {
        Asynch14penW::new(self, 14)
    }
    #[doc = "Bit 15 - ASYNCH15 pin enable control bit"]
    #[inline(always)]
    #[must_use]
    pub fn asynch15pen(&mut self) -> Asynch15penW<Prs0RouteenSpec> {
        Asynch15penW::new(self, 15)
    }
    #[doc = "Bit 16 - SYNCH0 pin enable control bit"]
    #[inline(always)]
    #[must_use]
    pub fn synch0pen(&mut self) -> Synch0penW<Prs0RouteenSpec> {
        Synch0penW::new(self, 16)
    }
    #[doc = "Bit 17 - SYNCH1 pin enable control bit"]
    #[inline(always)]
    #[must_use]
    pub fn synch1pen(&mut self) -> Synch1penW<Prs0RouteenSpec> {
        Synch1penW::new(self, 17)
    }
    #[doc = "Bit 18 - SYNCH2 pin enable control bit"]
    #[inline(always)]
    #[must_use]
    pub fn synch2pen(&mut self) -> Synch2penW<Prs0RouteenSpec> {
        Synch2penW::new(self, 18)
    }
    #[doc = "Bit 19 - SYNCH3 pin enable control bit"]
    #[inline(always)]
    #[must_use]
    pub fn synch3pen(&mut self) -> Synch3penW<Prs0RouteenSpec> {
        Synch3penW::new(self, 19)
    }
}
