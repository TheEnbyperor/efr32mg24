...
pub type R = crate::R<Prs0Asynch3routeSpec>;
#[doc = "Register `PRS0_ASYNCH3ROUTE` writer"]
pub type W = crate::W<Prs0Asynch3routeSpec>;
...
pub struct Prs0Asynch3routeSpec;
impl crate::RegisterSpec for Prs0Asynch3routeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`prs0_asynch3route::R`](R) reader structure"]
impl crate::Readable for Prs0Asynch3routeSpec {}
