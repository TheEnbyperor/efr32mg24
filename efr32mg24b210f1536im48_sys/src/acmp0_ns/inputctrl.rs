...
impl PosselR {
    ...
    pub const fn variant(&self) -> Option<Possel> {
        match self.bits {
            ...
            65 => Some(Possel::Vdac0out1),
            67 => Some(Possel::Vdac1out1),
    ...
    #[inline(always)]
    pub fn is_vdac0out1(&self) -> bool {
        *self == Possel::Vdac0out1
    }
    #[doc = "VDAC1 channel 1 output"]
    #[inline(always)]
    pub fn is_vdac1out1(&self) -> bool {
        *self == Possel::Vdac1out1
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "VDAC0 channel 1 output"]
    #[inline(always)]
    pub fn vdac0out1(self) -> &'a mut crate::W<REG> {
        self.variant(Possel::Vdac0out1)
    }
    #[doc = "VDAC1 channel 1 output"]
    #[inline(always)]
    pub fn vdac1out1(self) -> &'a mut crate::W<REG> {
        self.variant(Possel::Vdac1out1)
    }
    #[doc = "External interface, base is PA0."]
    #[inline(always)]
...
impl NegselR {
    ...
    pub const fn variant(&self) -> Option<Negsel> {
        match self.bits {
            ...
            64 => Some(Negsel::Vdac0out0),
            66 => Some(Negsel::Vdac1out0),
            128 => Some(Negsel::Pa0),
            129 => Some(Negsel::Pa1),
            130 => Some(Negsel::Pa2),
            131 => Some(Negsel::Pa3),
    ...
    #[inline(always)]
    pub fn is_vdac0out0(&self) -> bool {
        *self == Negsel::Vdac0out0
    }
    #[doc = "VDAC1 channel 0 output"]
    #[inline(always)]
    pub fn is_vdac1out0(&self) -> bool {
        *self == Negsel::Vdac1out0
    }
    #[doc = "Port A, Pin0"]
    #[inline(always)]
    pub fn is_pa0(&self) -> bool {
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "VDAC0 channel 0 output"]
    #[inline(always)]
    pub fn vdac0out0(self) -> &'a mut crate::W<REG> {
        self.variant(Negsel::Vdac0out0)
    }
    #[doc = "VDAC1 channel 0 output"]
    #[inline(always)]
    pub fn vdac1out0(self) -> &'a mut crate::W<REG> {
        self.variant(Negsel::Vdac1out0)
    }
    #[doc = "Port A, Pin0"]
    #[inline(always)]
    pub fn pa0(self) -> &'a mut crate::W<REG> {
