...
pub type R = crate::R<Sysrtc0clkctrlSpec>;
#[doc = "Register `SYSRTC0CLKCTRL` writer"]
pub type W = crate::W<Sysrtc0clkctrlSpec>;
#[doc = "Clock Select\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clksel(&mut self) -> ClkselW<Sysrtc0clkctrlSpec> {
        ClkselW::new(self, 0)
    }
}
...
pub struct Sysrtc0clkctrlSpec;
impl crate::RegisterSpec for Sysrtc0clkctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sysrtc0clkctrl::R`](R) reader structure"]
impl crate::Readable for Sysrtc0clkctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`sysrtc0clkctrl::W`](W) writer structure"]
impl crate::Writable for Sysrtc0clkctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SYSRTC0CLKCTRL to value 0x01"]
impl crate::Resettable for Sysrtc0clkctrlSpec {
